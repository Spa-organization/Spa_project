...
public class Admin_mangment {
    ...
    @When("I enter the a unique room {string}")
    public void iEnterTheAUniqueRoom(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    @When("I enter the employee {string} and it should be unique , name, and password")
    public void iEnterTheEmployeeAndItShouldBeUniqueNameAndPassword(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    @When("I enter the admin {string} and it should be unique , name, and password")
    public void iEnterTheAdminAndItShouldBeUniqueNameAndPassword(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    @When("I enter a specific {string}")
    public void iEnterASpecific(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    @Then("the appointments should show up according to the given date")
    public void theAppointmentsShouldShowUpAccordingToTheGivenDate() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    public void giveTheOfThisEmployee(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
